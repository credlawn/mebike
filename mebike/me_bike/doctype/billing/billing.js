    ...
    refresh: function(frm) { 
        if (frm.fields_dict['select_quantity']) {
            ...
            $('#add_item_btn').on('click', function() {
                ...
                // Fetch the item details to get minimum_quantity and maximum_quantity
                frappe.call({
                    ...
                    callback: function(r) {
                        if (r.message) {
                            ...
                            // Proceed to add item if quantity is valid
        ...
        if (frappe.user.has_role('Manns Partner') && frm.doc.status === 'Invoice Pending' && !frm.is_new()) {
